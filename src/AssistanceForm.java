...
public class AssistanceForm extends JFrame {
	static AssistanceForm frame;
	...
	public AssistanceForm() {
		...
		JLabel lblAddAssistance = new JLabel("Add Assistance");
		lblAddAssistance.setForeground(Color.DARK_GRAY);
		lblAddAssistance.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			int i=AssistanceDao.save(name, password, email, address, city, contact);
			if(i>0){
				JOptionPane.showMessageDialog(AssistanceForm.this,"Assistance added successfully!");
				AdminSuccess.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(AssistanceForm.this,"Sorry, unable to save!");
			}
			}
		});
