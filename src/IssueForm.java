...
public class IssueForm extends JFrame {
	...
	public IssueForm() {
		...
		JLabel lblInventoryName = new JLabel("Callno:");
		...
		btnIssueInventory.addActionListener(new ActionListener() {
			...
			String inventorycallno=textField_1.getText();
			...
			if(IssueDao.checkInventory(inventorycallno)){
			
			int i=IssueDao.save(inventorycallno, studentid, studentname, studentcontact);
			if(i>0){
				JOptionPane.showMessageDialog(IssueForm.this,"Issued successfully!");
				AssistanceSuccess.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(IssueForm.this,"Sorry, unable to issue!");
			}//end of save if-else
			
			}else{
				JOptionPane.showMessageDialog(IssueForm.this,"Sorry, Callno doesn't exist!");
			}//end of checkinventory if-else
		...
		JLabel lblNewLabel_1 = new JLabel("Note: Please check Student ID Carefully issuing!");
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
								...
								.addGroup(gl_contentPane.createSequentialGroup()
									.addComponent(btnIssueInventory, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE)
									.addGap(47)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						.addComponent(btnIssueInventory, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnBack))
					.addGap(18)
					.addComponent(lblNewLabel_1)
					.addGap(25))
