...
public class GlasswareForm extends JFrame {
	static GlasswareForm frame;
	...
	public GlasswareForm() {
		...
		JLabel lblAddInventories = new JLabel("Glassware And Chemical ");
		lblAddInventories.setForeground(Color.GRAY);
		lblAddInventories.setFont(new Font("Tahoma", Font.PLAIN, 18));
		
		JLabel lblCallNo = new JLabel("Call No:");
		
		JLabel lblName = new JLabel("Name:");
		
		JLabel lblAuthor = new JLabel("Category:");
		
		JLabel lblPublisher = new JLabel("Description:");
		...
		JButton btnAddInventories = new JButton("Add");
		btnAddInventories.addActionListener(new ActionListener() {
			...
			int i=GlasswareDao.save(callno, name, category, description, quantity);
			if(i>0){
				JOptionPane.showMessageDialog(GlasswareForm.this,"added successfully!");
				AssistanceSuccess.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(GlasswareForm.this,"Sorry, unable to save!");
			}
			}
		});
			...
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(150)
							.addComponent(lblAddInventories))
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(18)
				...
				.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
					.addGap(161)
					.addComponent(btnAddInventories, GroupLayout.PREFERRED_SIZE, 101, GroupLayout.PREFERRED_SIZE)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(30)
					.addComponent(btnAddInventories, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE)
